...
|----|----|----|----|----|----|----|----|----|----|----|
| Meat Data | Food | Homogenized raw meat samples from 5 animal species (Beef, Chicken, Lamb, Pork, Turkey), measured by near infrared spectroscopy | 231 | 1050 | 5 | Downey et al. (2000) | Anderlucci et al. (2022) | AffPr, GMM, HDDC-B, HDDC-C, KM, PAM, RP, RPEClu, SpeCl, Ward | RPEClu | ARI=0.32 |
...
| Lymphoma | Genomics | Lymphoma gene expression: DLBCL, FL, CLL | 62 | 4026 | 3 | Alizadeh et al. (2000) | Anderlucci et al. (2022) | AffPr, GMM, HDDC-B, HDDC-C, KM, PAM, RP, RPEClu, SpeCl, Ward | RPEClu | ARI=1.00 |
...
| Prostate-GE | Genomics | Prostate cancer microarray dataset (tumor and normal tissue) | 102 | 5966 | 2 | Singh et al. (2002) | Guo et al. (2018) | KM + varied UFS | KM + DGUFS | ACC=65.3, NMI=6.59 |
...
| PIE 10P | Images | Subset of PIE (Pose, Illumination, and Expression) face images from 10 people | 210 | 2420 | 10 | Gross et al. (2008) | Guo et al. (2018) | KM + varied UFS | KM + DGUFS | ACC=51.9, NMI=55.0 |
