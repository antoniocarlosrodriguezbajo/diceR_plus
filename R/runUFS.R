#' @title Execute Unsupervised Feature Selection (UFS) Methods in MATLAB (default parameters)
#'
...
#' @title Execute Unsupervised Feature Selection (UFS) Methods in MATLAB (manual parameters selection)
#'
#' @description This function establishes a connection to a running MATLAB server, processes a given dataset
#' using various unsupervised feature selection (UFS) methods, retrieves results, and closes the session.
#'
#' The function dynamically interacts with MATLAB, executing predefined feature selection methods
#'
#' @param data A numeric matrix or data frame representing the dataset to be analyzed.
#' @param UFS_Methods A list specifying which UFS methods should be executed.
#'
#' @return A named list containing results from each executed UFS method.
#'
#' @references
...
#'
#' @export
runUFS_manual_params <- function(data, UFS_Methods) {
